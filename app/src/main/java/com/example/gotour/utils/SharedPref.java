...
public class SharedPref {
    ...
    public SharedPref(Context context) {
        ...
        sharedpreferences = context.getSharedPreferences("SAAHAYAK", Context.MODE_PRIVATE);
    ...
    public void login(Context context, boolean connected) {
        sharedpreferences = context.getSharedPreferences("SAAHAYAK", 0);
        prefsEditor = sharedpreferences.edit();
    ...
    public boolean isLogin(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("SAAHAYAK", 0);
